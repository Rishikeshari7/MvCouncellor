...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "custom-gradient0":
          "linear-gradient(180deg, #FEFDA4 0%, #B39138 75%, #FEF99D 100%)",
        "custom-gradient":
          "linear-gradient(180deg, #FEFDA4 0%, #B39138 32%, #FEF99D 100%)",
        "custom-gradient2":
          "linear-gradient(180deg, #FEFDA4 15%, #B39138 80%, #FEF99D 99%)",
        "custom-gradient3":
